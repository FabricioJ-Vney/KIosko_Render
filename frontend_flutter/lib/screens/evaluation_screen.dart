...
class EvaluationScreen extends StatefulWidget {
  ...
  const EvaluationScreen({super.key, this.projectId, required this.projectName});
...
class _EvaluationScreenState extends State<EvaluationScreen> {
  ...
  void _initializeScores() {
    if (_selectedRubric != null) {
      final items = _selectedRubric!['items'] as List;
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      final evaluation = Evaluation(
        ...
        evaluatorId: "teacher_1",
        rubricId: _selectedRubric?['_id'],
              ...
              child: Column(
                ...
                children: [
                  ...
                  DropdownButtonFormField<Map<String, dynamic>>(
                    initialValue: _selectedRubric,
                    decoration: const InputDecoration(border: OutlineInputBorder()),
                    items: _rubrics.map<DropdownMenuItem<Map<String, dynamic>>>((r) => DropdownMenuItem(
                  ...
                  if (_selectedRubric != null) ...[
                    ...
                    ...(_selectedRubric!['items'] as List).map((item) {
